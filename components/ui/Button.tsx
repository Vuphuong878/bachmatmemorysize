...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  variant?: 'primary' | 'secondary' | 'choice' | 'compact';
}
...
const Button: React.FC<ButtonProps> = ({ children, variant = 'primary', className, ...props }) => {
  ...
  const variantClasses = {
    ...
    compact: '!w-auto text-sm py-1.5 px-4 font-rajdhani uppercase tracking-wider font-bold bg-transparent border border-[#a08cb6] text-[#a08cb6] shadow-[0_0_4px_rgba(160,140,182,0.2),inset_0_0_4px_rgba(160,140,182,0.1)] hover:bg-[#a08cb6] hover:text-[#120c18] hover:shadow-[0_0_8px_#a08cb6] focus:ring-2 focus:ring-[#a08cb6]/50 disabled:shadow-none disabled:border-gray-700 disabled:text-gray-700 disabled:bg-transparent'
  };
